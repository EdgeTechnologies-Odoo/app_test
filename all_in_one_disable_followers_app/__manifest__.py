...

{
    ...
    'summary' : 'All Disable follower on Odoo Disable follower on sale disable follower on purchase disable follower on invoice disable follower on bill disable follower stop subscription stop auto follower stop automatic follower stop follower on order disable follower ',
