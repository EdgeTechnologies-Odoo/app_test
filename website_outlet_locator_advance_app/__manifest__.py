# -*- coding: utf-8 -*-
{
    'name': 'Advance Website Shop/Outlet Location On Google Map',
    "author": "Edge Technologies",
    'version': '13.0.1.3',
    'live_test_url': "https://youtu.be/0b41VavreXY",
    "images":['static/description/main_screenshot.png'],
    'summary': "Website store locator on google map website store location finder website Share store location shop locator google store locator google locator on website location finder website Outlet Location on Website Google Map on website store locator on website",
...
Website Shop/Outlet locater module used to locate all your offline Shops/Outlets on Google Map on your website with shop address, email and contact details.
...
outlet locater branch locater on website eCommerce store location with google map webshop location eCommerce store locator webshop locator with google map 
    """,
    "license" : "OPL-1",
    'depends': ['base','web','website','website_outlet_locator_app'],
    ...
    'data': [
        ...
        'views/store_location_setting_view.xml',
